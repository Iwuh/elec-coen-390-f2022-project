...
public:
  ...
  // Otherwise, returns -1.
  int64_t findAndRemove(int64_t timestamp_us) {    
  ...
  size_t clean(int64_t timestamp_us) {
...
private:
  ...
  static constexpr int64_t MIN_TH = 500000;
  ...
  static constexpr int64_t MAX_TH = 2000000;

  int64_t events[ARRAY_MAX];
  size_t eventCount;
};